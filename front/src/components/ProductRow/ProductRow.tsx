...
export default function ProductRow({
	name, price, product_id, quantity, changeQuantity, deleteP, onDoubleClick, error, contextMenuItems }: ProductRow) {
	...
	const [anchorEl, setAnchorEl] = createSignal<HTMLTableRowElement | null>(null);
	...
	return (
		<TableRow 
			...
			aria-describedby={id()} 
			sx={{ backgroundColor: error ? "indianred" : "white",userSelect:"none" }}
